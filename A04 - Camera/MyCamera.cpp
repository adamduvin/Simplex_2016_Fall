...
vector3 Simplex::MyCamera::GetPosition() { return m_v3Position; }	// Made this to access position

vector3 Simplex::MyCamera::GetUp() { return m_v3Up; }	// Made this to access position
